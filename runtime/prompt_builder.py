...
"""
    ...
    user_payload = {
        ...
        "mission": command_spec.get("mission"),
        "target": step.get("target"),
        "depth": step.get("depth"),
        "methods": step.get("methods", []),
        "lenses": step.get("lenses", []),
        "previous_outputs": previous_outputs,
        "tool_context": tool_context,
    }
    contract = {
        "required_outputs": command_spec.get("default_output", []),
...
"""
    ...
    return LLMRequest(
        purpose="council_expert_view",
        system=system,
        user=user,
        metadata={"expert_id": expert.get("id"), "target": target},
        response_contract={
            "required_meta": ["summary", "outputs", "epistemic", "confidence"]
        },
    )
...
"""
    ...
    return LLMRequest(
        purpose="council_arbitration",
        system=system,
        user=user,
        metadata={"target": target},
        response_contract={
            "required_meta": ["summary", "disagreements", "outputs", "epistemic", "confidence"]
        },
    )
